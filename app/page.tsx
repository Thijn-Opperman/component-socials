...
import Socials, { SocialLink, StyleOverrides } from "@/components/Socials";
...
export default function Home() {
  ...
  const editorSlideStyle = useMemo<CSSProperties>(
    () => ({
  ...
  return (
    <div className="relative min-h-screen overflow-hidden text-slate-900" style={heroBackgroundStyle}>
      ...
      <div
        className="fixed left-0 top-0 z-40 h-full w-[90%] max-w-[400px] bg-white dark:bg-gray-900 shadow-2xl border-r border-gray-200/70 dark:border-gray-800 transition-transform duration-500 ease-in-out"
        style={editorSlideStyle}
      >
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200/80 dark:border-gray-800">
            ...
            {links.map((link, index) => (
              <div key={index} className="p-5 space-y-3">
                <div className="flex items-center justify-between">
                  <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">Link {index + 1}</p>
                  <button
                    type="button"
          ...
          <div className="border-t border-gray-100 dark:border-gray-800 p-5 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <label className="text-[10px] font-semibold uppercase text-gray-500">
                ...
                <input
                  ...
                  value={appearance.bgFrom}
                  onChange={(event) => handleAppearanceChange("bgFrom", event.target.value)}
                />
              </label>
              <label className="text-[10px] font-semibold uppercase text-gray-500">
                Hero naar
                <input
                  type="color"
                  className="mt-1 h-10 w-full cursor-pointer rounded border border-gray-200"
                  value={appearance.bgTo}
                  onChange={(event) => handleAppearanceChange("bgTo", event.target.value)}
                />
              </label>
              <label className="text-[10px] font-semibold uppercase text-gray-500">
                Sectie van
                <input
                  type="color"
                  className="mt-1 h-10 w-full cursor-pointer rounded border border-gray-200"
                  value={appearance.sectionFrom}
                  onChange={(event) => handleAppearanceChange("sectionFrom", event.target.value)}
                />
              </label>
              <label className="text-[10px] font-semibold uppercase text-gray-500">
                Sectie naar
                <input
                  type="color"
                  className="mt-1 h-10 w-full cursor-pointer rounded border border-gray-200"
                  value={appearance.sectionTo}
                  onChange={(event) => handleAppearanceChange("sectionTo", event.target.value)}
                />
              </label>
              <label className="text-[10px] font-semibold uppercase text-gray-500">
                Accent 1
                <input
                  ...
                  onChange={(event) => handleAppearanceChange("accentFrom", event.target.value)}
                />
              </label>
              <label className="text-[10px] font-semibold uppercase text-gray-500">
                Accent 2
                <input
                  ...
                  onChange={(event) => handleAppearanceChange("accentTo", event.target.value)}
                />
              </label>
            </div>
            ...
            <label className="text-xs font-semibold uppercase text-gray-500">
              ...
              <select
                ...
                onChange={(event) => handleAppearanceChange("headingTone", event.target.value as AppearanceState["headingTone"])}
              >
